...
// runSnapshot streams the stage log once and exits at EOF. A pre-stream 404
// ("logs not available yet") is turned into a friendly, actionable message and
// a non-zero exit rather than a raw API error.
