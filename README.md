...
| [`rde preview-link create`](docs/cli/bitrise-cli_rde_preview-link_create.md) | Mint a shareable device preview link for an app build |
...
| [`rde session delete-terminated`](docs/cli/bitrise-cli_rde_session_delete-terminated.md) | Permanently delete your terminated sessions, or the workspace's with --scope workspace |
